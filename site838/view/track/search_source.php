<?php
//------------------------------
//create time:2008-5-22
//creater:zll,liang_0735@21cn.com,www.mwjx.com
//purpose:添加搜索来源URL列表
//------------------------------
//必须要cd到这个目录下才执行下面的命令
//cd /usr/home/mwjx/fish838.com/site838/view/track/
///usr/local/php/bin/php /usr/home/mwjx/fish838.com/site838/view/track/search_source.php
//var_dump(extension_loaded("zlib")); 
exit();
$_SERVER["PHP_SELF"] = "/site838/view/track/search_source.php";
...
$str_post = "__EVENTTARGET=_ctl0%3Apager&__EVENTARGUMENT=3&__VIEWSTATE=dDw1MzgxO3Q8O2w8aTwwPjs%2BO2w8dDw7bDxpPDExPjs%2BO2w8dDw7bDxpPDE%2BO2k8NT47PjtsPHQ8dDw7O2w8aTwwPjs%2BPjs7Pjt0PHA8cDxsPFJlY29yZGNvdW50O0N1c3RvbUluZm9UZXh0O0N1cnJlbnRQYWdlSW5kZXg7PjtsPGk8MjUzMj47Jm5ic3BcO%2BiusOW9lSBcPGZvbnQgY29sb3I9cmVkXD5cPGJcPjI1MzJcPC9iXD5cPC9mb250XD4g5p2hICwg5b2T5YmNIFw8Zm9udCBjb2xvcj1yZWRcPlw8Ylw%2BMlw8L2JcPlw8L2ZvbnRcPiAvIFw8Zm9udCBjb2xvcj1ibHVlXD5cPGJcPjUxXDwvYlw%2BXDwvZm9udFw%2BIOmhtTtpPDI%2BOz4%2BOz47Oz47Pj47Pj47Pj47Pg%3D%3D&_ctl0%3Aorderbyid=0&_ctl0%3Apager_input=2";

$m_code = "dDw1MzgxO3Q8O2w8aTwwPjs%2BO2w8dDw7bDxpPDExPjs%2BO2w8dDw7bDxpPDE%2BO2k8NT47PjtsPHQ8dDw7O2w8aTwwPjs%2BPjs7Pjt0PHA8cDxsPFJlY29yZGNvdW50O0N1c3RvbUluZm9UZXh0O0N1cnJlbnRQYWdlSW5kZXg7PjtsPGk8MjUzMj47Jm5ic3BcO%2BiusOW9lSBcPGZvbnQgY29sb3I9cmVkXD5cPGJcPjI1MzJcPC9iXD5cPC9mb250XD4g5p2hICwg5b2T5YmNIFw8Zm9udCBjb2xvcj1yZWRcPlw8Ylw%2BMlw8L2JcPlw8L2ZvbnRcPiAvIFw8Zm9udCBjb2xvcj1ibHVlXD5cPGJcPjUxXDwvYlw%2BXDwvZm9udFw%2BIOmhtTtpPDI%2BOz4%2BOz47Oz47Pj47Pj47Pj47Pg%3D%3D";
$m_site = 15; //站点
$m_max = 52; //最大页数
$m_url = "http://www.bookjia.com/Book/ShowBooklist.aspx";
//清除旧记录
$str_sql = "delete from search_source where site='".$m_site."' and t='2'";
$sql = new mysql;
$sql->query($str_sql);
$sql->close();
...
for($i = 1;$i <= $m_max;++$i){
	$page = $i;
	$str_sql = "__EVENTTARGET=_ctl0%3Apager&__EVENTARGUMENT=".$page."&__VIEWSTATE=".$m_code."&_ctl0%3Aorderbyid=0&_ctl0%3Apager_input=".$page;
	$str_sql = "insert into search_source(site,url,post,t)values('".$m_site."','".$m_url."#".$page."','".$str_sql."','2');";
	$sql = new mysql;
	$sql->query($str_sql);
	$sql->close();
}
/*
1.固定不知什么__EVENTTARGET=_ctl0:pager
2.页数&__EVENTARGUMENT=3
3.不知什么&__VIEWSTATE=
4.固定可能是排序方式&_ctl0:orderbyid=0
5.直接跳转到的页数&_ctl0:pager_input=2
*/
echo "OVER!";
//echo urldecode($str_post);
exit();
