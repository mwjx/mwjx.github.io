...
//被选中文章
//选中类目ID(str)=>array({类目ID(str),标题(str),来源类目ID(str)})
var m_arr_ed = Array(); 
...
function unlink(id)
{
	...
	//alert(edid+":"+id);
	//----------提交---------
	str = ("fun=unlink_class&cid="+edid+"&id="+id);
...
function mv2ed(id)
{
	...
	var edid = classid_un_ed(1);
	//return alert(unid+":"+edid);
	//"" == unid || 
	if("" == edid)
		return alert("类目ID无效,请选择一个选中区类目"); //类目ID无效
	if(ed_had(edid,id))	
		return alert("不要重复归入同一个类目");
	var o = class_list_un;
...
function classid_un_ed(flag)
{
	...
	var o = null;
	if(0 == flag)
		o = document.all["class_list_un"];
	else
		o = document.all["class_list_ed"];
...
<FRAMESET frameBorder="1" frameSpacing="0" rows="85%,15%">
	<FRAMESET frameBorder="1" frameSpacing="0" cols="50%,50%">
		<FRAMESET frameBorder="1" frameSpacing="0" rows="40%,60%">
			<FRAME frameBorder="0" marginHeight="0" marginWidth="0"  noResize="yes" scrolling="auto" src="./data_all_class.php?type=class_link_un"></FRAME>
			<FRAME id="class_list_un" frameBorder="0" marginHeight="0" marginWidth="0"  noResize="yes" scrolling="auto" src=""></FRAME>
		</FRAMESET>
		<FRAMESET frameBorder="1" frameSpacing="0" rows="40%,60%">
			<FRAME frameBorder="0" marginHeight="0" marginWidth="0"  noResize="yes" scrolling="auto" src="./data_all_class.php?type=class_link_ed"></FRAME>
			<FRAME id="class_list_ed" frameBorder="0" marginHeight="0" marginWidth="0"  noResize="yes" scrolling="auto" src=""></FRAME>
		</FRAMESET>
	</FRAMESET>
	<FRAME id="frame_toolbar" frameBorder="0" marginHeight="0" marginWidth="0"  noResize="yes" scrolling="auto" src="./classlink_toolbar.php" onload="javascript:init_toolbar();"></FRAME>
</FRAMESET>
<BODY>
</BODY>
</HTML>
